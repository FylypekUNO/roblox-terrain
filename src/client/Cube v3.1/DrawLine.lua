...
local function drawLine(parent: Instance, a: Vector3, b: Vector3, color: Color3?, thickness: number?): Part
	...
	rayPart.Color = color :: Color3
	rayPart.Transparency = 0.7
	rayPart.CFrame = CFrame.lookAt(origin, b)
