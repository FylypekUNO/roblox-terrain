...
local function drawCube(parent: Instance, positions: { Vector3 }, densities: { number }): ()
	...
	if #potentialCorners > 2 then
		...
		elseif #potentialCorners == 5 then
			drawTriangle(parent, potentialCorners[1], potentialCorners[2], potentialCorners[3])
			drawTriangle(parent, potentialCorners[1], potentialCorners[3], potentialCorners[5])
